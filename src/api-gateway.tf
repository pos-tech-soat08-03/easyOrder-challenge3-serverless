...
#   type                    = "HTTP"
#   uri                     = "http://example.com/" # Substitua pelo URL real
...
resource "aws_api_gateway_integration" "health_get_integration" {
  ...
  type                    = "HTTP_PROXY"
  uri                     = "http://a3467471924424bc18a5c1896774568f-1166617031.us-east-1.elb.amazonaws.com/health" # Substitua pelo URL real
  integration_http_method = "GET"
}
...
resource "aws_api_gateway_integration" "docs_get_integration" {
  ...
  type                    = "HTTP_PROXY"
  uri                     = "http://a3467471924424bc18a5c1896774568f-1166617031.us-east-1.elb.amazonaws.com/docs" # Substitua pelo URL real
  integration_http_method = "GET"
}
...
resource "aws_api_gateway_integration" "cliente_cadastrar_integration" {
  ...
  type                    = "HTTP_PROXY"
  uri                     = "http://a3467471924424bc18a5c1896774568f-1166617031.us-east-1.elb.amazonaws.com/cliente-cadastrar" # Altere para o URL real
...
resource "aws_api_gateway_integration" "cliente_atualizar_integration" {
  ...
  type                    = "HTTP_PROXY"
  uri                     = "http://a3467471924424bc18a5c1896774568f-1166617031.us-east-1.elb.amazonaws.com/cliente-atualizar" # Altere para o URL real
...
resource "aws_api_gateway_integration" "cliente_listar_integration" {
  ...
  type                    = "HTTP_PROXY"
  uri                     = "http://a3467471924424bc18a5c1896774568f-1166617031.us-east-1.elb.amazonaws.com/cliente-listar" # Altere para o URL real
  integration_http_method = "GET"
}
...
resource "aws_api_gateway_integration" "pagamento_webhook_integration" {
  ...
  type                    = "HTTP_PROXY"
  uri                     = "http://a3467471924424bc18a5c1896774568f-1166617031.us-east-1.elb.amazonaws.com/backend-webhook-endpoint" # Substitua pelo URL real
  integration_http_method = "POST"
}
...
resource "aws_api_gateway_integration" "pagamento_listar_transacoes_pedidoId_integration" {
  ...
  type                    = "HTTP_PROXY"
  uri                     = "http://a3467471924424bc18a5c1896774568f-1166617031.us-east-1.elb.amazonaws.com/backend-endpoint/{pedidoId}" # Substitua pelo URL real
  integration_http_method = "GET"
  request_parameters = {
...
resource "aws_api_gateway_integration" "pedido_post_integration" {
  ...
  type                    = "HTTP_PROXY"
  uri                     = "http://a3467471924424bc18a5c1896774568f-1166617031.us-east-1.elb.amazonaws.com/pedido-endpoint" # Substitua pelo URL real
  integration_http_method = "POST"
}
...
resource "aws_api_gateway_integration" "pedido_listar_statusPedido_integration" {
  ...
  type                    = "HTTP_PROXY"
  uri                     = "http://a3467471924424bc18a5c1896774568f-1166617031.us-east-1.elb.amazonaws.com/pedido-listar-endpoint/{statusPedido}" # Substitua pelo URL real
  integration_http_method = "GET"
  request_parameters = {
...
resource "aws_api_gateway_integration" "pedido_pedidoId_integration" {
  ...
  type                    = "HTTP_PROXY"
  uri                     = "http://a3467471924424bc18a5c1896774568f-1166617031.us-east-1.elb.amazonaws.com/pedido-endpoint/{pedidoId}" # Substitua pelo URL real
  integration_http_method = "GET"
  request_parameters = {
    "integration.request.path.pedidoId" = "method.request.path.pedidoId"
  }
...
resource "aws_api_gateway_integration" "pedido_pedidoId_cancelar_integration" {
  ...
  type                    = "HTTP_PROXY"
  uri                     = "http://a3467471924424bc18a5c1896774568f-1166617031.us-east-1.elb.amazonaws.com/pedido-cancelar-endpoint/{pedidoId}" # Substitua pelo URL real
  integration_http_method = "PUT"
  request_parameters = {
    "integration.request.path.pedidoId" = "method.request.path.pedidoId"
  }
...
resource "aws_api_gateway_integration" "pedido_pedidoId_confirmacao_pagamento_integration" {
  ...
  type                    = "HTTP_PROXY"
  uri                     = "http://a3467471924424bc18a5c1896774568f-1166617031.us-east-1.elb.amazonaws.com/pedido-confirmacao-pagamento-endpoint/{pedidoId}" # Substitua pelo URL real
  integration_http_method = "PUT"
  request_parameters = {
    "integration.request.path.pedidoId" = "method.request.path.pedidoId"
  }
...
resource "aws_api_gateway_integration" "pedido_pedidoId_checkout_integration" {
  ...
  type                    = "HTTP_PROXY"
  uri                     = "http://a3467471924424bc18a5c1896774568f-1166617031.us-east-1.elb.amazonaws.com/pedido-checkout-endpoint/{pedidoId}" # Substitua pelo URL real
  integration_http_method = "PUT"
  request_parameters = {
    "integration.request.path.pedidoId" = "method.request.path.pedidoId"
  }
...
resource "aws_api_gateway_integration" "pedido_pedidoId_combo_integration" {
  ...
  type                    = "HTTP_PROXY"
  uri                     = "http://a3467471924424bc18a5c1896774568f-1166617031.us-east-1.elb.amazonaws.com/pedido-combo-endpoint/{pedidoId}" # Substitua pelo URL real
  integration_http_method = "POST"
  request_parameters = {
    "integration.request.path.pedidoId" = "method.request.path.pedidoId"
  }
...
resource "aws_api_gateway_integration" "pedido_pedidoId_combo_comboId_integration" {
  ...
  type                    = "HTTP_PROXY"
  uri                     = "http://a3467471924424bc18a5c1896774568f-1166617031.us-east-1.elb.amazonaws.com/pedido-combo-endpoint/{pedidoId}/{comboId}" # Substitua pelo URL real
...
resource "aws_api_gateway_integration" "preparacao_pedido_proximo_integration" {
  ...
  type                    = "HTTP_PROXY"
  uri                     = "http://a3467471924424bc18a5c1896774568f-1166617031.us-east-1.elb.amazonaws.com/preparacao-pedido-proximo-endpoint" # Substitua pelo URL real
  integration_http_method = "GET"
}
...
resource "aws_api_gateway_integration" "preparacao_pedido_pedidoId_iniciar_preparacao_integration" {
  ...
  type                    = "HTTP_PROXY"
  uri                     = "http://a3467471924424bc18a5c1896774568f-1166617031.us-east-1.elb.amazonaws.com/preparacao-pedido-iniciar-preparacao/{pedidoId}" # Substitua pelo URL real
  integration_http_method = "PUT"
  request_parameters = {
    "integration.request.path.pedidoId" = "method.request.path.pedidoId"
  }
...
resource "aws_api_gateway_integration" "preparacao_pedido_pedidoId_finalizar_preparacao_integration" {
  ...
  type                    = "HTTP_PROXY"
  uri                     = "http://a3467471924424bc18a5c1896774568f-1166617031.us-east-1.elb.amazonaws.com/preparacao-pedido-finalizar-preparacao/{pedidoId}" # Substitua pelo URL real
  integration_http_method = "PUT"
  request_parameters = {
    "integration.request.path.pedidoId" = "method.request.path.pedidoId"
  }
...
resource "aws_api_gateway_integration" "preparacao_pedido_pedidoId_entregar_integration" {
  ...
  type                    = "HTTP_PROXY"
  uri                     = "http://a3467471924424bc18a5c1896774568f-1166617031.us-east-1.elb.amazonaws.com/preparacao-pedido-entregar/{pedidoId}" # Substitua pelo URL real
  integration_http_method = "PUT"
  request_parameters = {
    "integration.request.path.pedidoId" = "method.request.path.pedidoId"
  }
...
resource "aws_api_gateway_integration" "produto_listar_integration" {
  ...
  type                    = "HTTP_PROXY"
  uri                     = "http://a3467471924424bc18a5c1896774568f-1166617031.us-east-1.elb.amazonaws.com/produto-listar-endpoint" # Substitua pelo URL real
  integration_http_method = "GET"
}
...
resource "aws_api_gateway_integration" "produto_buscar_id_integration" {
  ...
  type                    = "HTTP_PROXY"
  uri                     = "http://a3467471924424bc18a5c1896774568f-1166617031.us-east-1.elb.amazonaws.com/produto-buscar-endpoint/{id}" # Substitua pelo URL real
  integration_http_method = "GET"
  request_parameters = {
...
resource "aws_api_gateway_integration" "produto_listar_categoria_integration" {
  ...
  type                    = "HTTP_PROXY"
  uri                     = "http://a3467471924424bc18a5c1896774568f-1166617031.us-east-1.elb.amazonaws.com/produto-listar-endpoint/{categoria}" # Substitua pelo URL real
  integration_http_method = "GET"
  request_parameters = {
...
resource "aws_api_gateway_integration" "produto_remover_id_integration" {
  ...
  type                    = "HTTP_PROXY"
  uri                     = "http://a3467471924424bc18a5c1896774568f-1166617031.us-east-1.elb.amazonaws.com/produto-remover-endpoint/{id}" # Substitua pelo URL real
  integration_http_method = "DELETE"
  request_parameters = {
    "integration.request.path.id" = "method.request.path.id"
  }
...
resource "aws_api_gateway_integration" "produto_cadastrar_integration" {
  ...
  type                    = "HTTP_PROXY"
  uri                     = "http://a3467471924424bc18a5c1896774568f-1166617031.us-east-1.elb.amazonaws.com/produto-cadastrar-endpoint" # Substitua pelo URL real
  integration_http_method = "POST"
}
...
resource "aws_api_gateway_integration" "produto_atualizar_integration" {
  ...
  type                    = "HTTP_PROXY"
  uri                     = "http://a3467471924424bc18a5c1896774568f-1166617031.us-east-1.elb.amazonaws.com/produto-atualizar-endpoint" # Substitua pelo URL real
  integration_http_method = "PUT"
}
